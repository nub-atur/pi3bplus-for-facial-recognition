...
while True:
	...
	for encoding in encodings:
		...
		if True in matches:
			...
			# determine the recognized face with the largest number of votes (note: in the event of an unlikely tie Python
			# will select first entry in the dictionary)
			name = max(counts, key=counts.get)
			
			#If someone in your dataset is identified, print their name on the screen, and play a sound file
			if currentname != name:
				currentname = name
				print(currentname)
				pygame.init()
